...
int main () {
	...
	U64 rook_magics[64] = {
	  ...
	  0x62880a0220200808U, 0x4042004000000ULL, 0x100822020200011ULL,
	...
	cout << hex << largest(rook_magics, 64) << endl;

	for (int i = 0; i < 64; ++i) {
		stringstream s;
		s << hex << rook_magics[i];
		int a = s.str().size();
		string extra = string(16 - a, '0');
		cout << "0x" << extra << hex << rook_magics[i] << "ULL";
		if (i != 63) cout << ", ";
		if (!((i + 1) % 3)) cout << endl;
	}
